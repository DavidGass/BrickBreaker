...
private:
	...
	static constexpr float borderPadding = 40.0f;
	int lives = 3;
	Paddle lifePaddles[3];
	static constexpr float lifePaddleHalfWidth = 10.0f;
	static constexpr float lifePaddleHalfHeight = 2.0f;
	FrameTimer timer;
	RectF walls;
	Paddle paddle;
	Ball ball;
